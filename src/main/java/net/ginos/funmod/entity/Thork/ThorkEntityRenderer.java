...
public class ThorkEntityRenderer extends EntityRenderer<ThorkEntity> {
    public static final Identifier TEXTURE =  Identifier.of(FunMod.MOD_ID, "textures/entity/thork.png");
    ...
    public void render(ThorkEntity tridentEntity, float f, float g, MatrixStack matrixStack, VertexConsumerProvider vertexConsumerProvider, int i) {
        matrixStack.push();
    ...
    @Override
    public Identifier getTexture(ThorkEntity entity) {
        return TEXTURE;
    }
