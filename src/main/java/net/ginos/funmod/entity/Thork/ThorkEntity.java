...
public class ThorkEntity extends PersistentProjectileEntity {
    ...
    public ThorkEntity(World world, double x, double y, double z, ItemStack stack) {
        super(ModEntities.THORK, x, y, z, world, stack, stack);
        this.dataTracker.set(LOYALTY, this.getLoyalty(stack));
        this.dataTracker.set(ENCHANTED, stack.hasGlint());
    }
    ...
    protected void onBlockHitEnchantmentEffects(ServerWorld world, BlockHitResult blockHitResult, ItemStack weaponStack) {
        ...
        EnchantmentHelper.onHitBlock(world, weaponStack, var10002, this, (EquipmentSlot) null, vec3d, world.getBlockState(blockHitResult.getBlockPos()), (item) -> this.kill());
    }
